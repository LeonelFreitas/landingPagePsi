                ...
                <Container>
                    ...
                    <div className="psicoterapia">
                        <Row id='psicoterapia' className={clsx(styles.list__psicoterapia, 'text-center mt-5 ps-5 pe-5')} hidden={!psicoterapiaAtivo}>
                            ...
                            <h2 data-aos="fade-out" data-aos-duration="1000" data-aos-delay="1850"   className={clsx(styles.title, styles.tratamentosInd)} style={{ marginBottom: '5rem' }}> Tratamentos Individuais</h2>
