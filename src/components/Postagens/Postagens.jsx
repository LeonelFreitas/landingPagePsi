                        ...
                        <Col data-aos="fade-out" data-aos-duration="1000" data-aos-delay="350" className={styles.postsItem} lg={3} md={4} sm={8}>
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <Button variant="primary" href='https://www.instagram.com/' target='blanc' >Ler mais</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                        ...
                        <Col data-aos="fade-out" data-aos-duration="1000" data-aos-delay="1350" className={styles.postsItem} lg={3} md={4} sm={8}>
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <Button href='https://www.instagram.com/' target='blanc' variant="primary">Ler mais</Button>
                                </Card.Body>
                            </Card>
                        </Col>
